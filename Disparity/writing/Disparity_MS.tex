...
% NC: Technically it should be Family and Genus throughout. But leave it for now I guess.
...
%---------------------------------------------------
\begin{abstract} %NC: Mostly I've made this more concise. Try not to over write things, keep it simple. f
...
% NC: This paragraph doesn't really say anything at all. Maybe delete and start with next paragraph. Or make it more obvious what the point of the paragraph is. i.e. WHY is is there? Why do you need it to tell your story?
...
% NC: Take more care over being concise. is compromised of = contains
...
% NC: Is all this relevant? Can't you just say tenrecs have 34 species, 31 on Mad, and are an example of an adaptive radiation because they exhibit loads of morpho diversity i.e. some look like shrews etc. [i.e. combine these two paragraphs.]
...
% NC: I wouldn't say this - if it goes to Link he'll most certainly disagree!
...
% NC: Again I think this paragraph can be combined wit hthe one before. Doesn't really matter that there are different ways to measure disparity, and you can get away with just defining in the methods I think.

	Our results show an overall trend for higher morphological diversity in tenrec crania compared to those of golden moles. However these differences are not statistically significant, indicating that, with regards to cranial shape, tenrecs are not as phenotypically diverse as is often assumed. % NC: Hmm well technically you've shown they're no more diverse than golden moles. They might still be super diverse compared to other stuff.
	In contrast, we found significantly greater morphological disparity in golden mole mandibles compared to tenrecs, seemingly due to more variable posterior mandible morphologies in golden moles. % NC: This is a bit technical for the intro
...
\subsection{Morphological data collection} 
	...
	% NC: Not really worth it for so few numbers. 
...
% NC: Perhaps make the 4 clearer? I had to read multiple times to see what you meant. so perhaps (1) the sum of the range, (2) the product of the range, (3) the sum of the variance and (4) the product of the variance of the morphospace occupied by each family. ? Or re-write to make even clearer.
...
% NC: Now this is shorted I'd stick the rarefaction in here too
%-----------------------------------------------------------
...
\subsection{Morphological disparity in tenrecs and golden moles} 
	...
	% NC: I think it should be higher or lower disparity. NOT higher or lower levels of disparity.
...
\section{Discussion} 
	...
	It is evident that tenrecs are a diverse group, both phenotypically and ecologically. Body sizes of extant tenrecs span three orders of magnitude (2.5 to $>$ 2,000g) which is a greater range than all other Families, and most Orders, of living mammals \citep{Olson2003}.% NC Could alternatively cite the PanTHERIA dataset here
	...
	In contrast, although golden moles occupy a wide altitudinal, climatic and vegetational spectrum of habitats \citep{Bronner1995}, they are are all fossorial species which, superficially at least, appear to be less phenotypically diverse than tenrecs. % NC: Do you mean phenotypically or functionally here?
...
\section*{Acknowledgements}
	...
	We thank Fran\c{c}ois Gould, Dean Adams, David Polly, Gary Bronner, Steve Brusatte, Steve Wang, Luke Harmon, Thomas Guillerme and the members of NERD club for insightful discussions and the museum % NC: worth making sure you spell museum correctly :P
