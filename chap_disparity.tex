...
%SF: I haven't repeated the paper's introduction here because the information is in the introduction of my thesis instead.
	%Do I need a separate introduction for this chapter since it's a continuation of the main introduction and methods chapter?
	%Is this introduction too much like an abstract?
...
\subsection{\normalfont{Calculating morphological diversity}}
	...
	Secondly, I compared morphological diversity within tenrecs to the diversity within golden moles. I define diversity as the mean Euclidean distance between each species and its Family centroid. 
	%NC: Maybe have a diagram here?
...
%Put back in some of the discussion about mandibles: see previous versions of the disparity paper
