...
%######################################
%Long tables
	%I couldn't get the long tables to work when they were being input as seperate files so I changed to copying the full tables into here
%######################################
%Skull measurements
	%The \hline placement gives an error message but it still works anyway
	%The error comes from putting the caption in before \hline but if I put it in at the end then the caption is below the table

\begin{longtable}{p{.20\textwidth}p{.20\textwidth}p{0.60\textwidth}}
\caption[Skull measurements]
			{Abbreviations and descriptions for the linear measurements of skulls. All measurements were repeated three times except for those marked with * which were measured five times.}
\hline
...
\caption[Limb measurements]
		{Abbreviations and descriptions for the linear measurements of limbs. All measurements were repeated three times except for those marked with * which were measured five times.} 
\hline
\textbf{Abbreviation} & \textbf{Measurement} & \textbf{Description}\\
\hline
