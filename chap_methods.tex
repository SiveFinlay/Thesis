...
% NC: I've capitalised Table, Figure and Appendix as standard. Partly because it draws attention to them when skim reading.

% NC: The tables are all still a bit wide and look messy because of this. Make them a bit narrower so they line up with the margins. You could put them on landscape oriented pages if that helps?
...
\section{Overview}
	...
	% NC: Depends if you want to upload them or not. Up to you :)
	\end{enumerate} 
...
\subsection{\normalfont{Landmark placement on images}}
	...
	I used a combination of landmark and semilandmark analysis approaches to assess the shape variability in my skull and mandible specimens. % NC: Avoid one line paragraphs 
	...
	When combining landmark and semilandmark approaches, there is a potential problem of over-sampling the curves leading to pseudoreplication in the shape information % NC: I assume that's why this is an issue?
